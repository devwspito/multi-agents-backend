/**
 * Shared MCP Tools Documentation
 *
 * These constants contain documentation for MCP tools available to different agents.
 * Extracted from AgentDefinitions.ts for better maintainability.
 */

/**
 * MCP Tools section for Developer agents
 * Full set of tools including execution, refactoring, and memory
 */
...
/**
 * MCP Tools section for Planning agents (read-only, analysis tools)
 */
...
/**
 * MCP Tools section for Judge agents (analysis and verification)
 */
