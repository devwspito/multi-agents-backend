...
export DATABASE_URL=***REMOVED***localhost:5432/app_dev
...
export function checkEnvSafety(envVars: Record<string, string>): EnvSafetyResult[] {
  ...
  const dangerousPatterns = [
    ...
    { pattern: /\.rds\.amazonaws\.com/i, name: 'AWS RDS', suggestion: '***REMOVED***localhost:5432/app_dev' },
...
export const LOCAL_DB_CONNECTIONS = {
  ...
  postgresql: '***REMOVED***localhost:5432/app_dev',
  mysql: '***REMOVED***localhost:3306/app_dev',
